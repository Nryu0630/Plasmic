...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: bI8ZV1xHcT65/css
import Searchsvg2Icon from "./icons/PlasmicIcon__Searchsvg2"; // plasmic-import: hoQe6hxar61I/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: B5xtoo8WuBtX/icon
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg__p1BbT)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__dDmhw)}
              role={"img"}
            />
          ),
