...
import sty from "./PlasmicButton.module.css"; // plasmic-import: uoR8V4VpY2lm/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___4Hdzw)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__n7J3K)}
                role={"img"}
              />
            ),
